...
export default function LoanForm() {
  ...
  if (!fullForm) {
    return (
      <div className="min-h-screen flex items-center justify-center px-4 bg-gray-800 text-white">
        <div className="w-full max-w-md bg-gray-900 shadow-lg rounded-2xl p-6 space-y-4">
          ...
          >
            ...
            <div>
              ...
              <select name="employmentStatus" required className="w-full px-3 py-2 border rounded-lg">
            ...
            <div>
              ...
              <select name="loanTerm" required className="w-full px-3 py-2 border rounded-lg">
                <option value="">Select</option>
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-800 text-white">
      <div className="w-full max-w-2xl bg-gray-900 shadow-2xl rounded-2xl p-6 sm:p-8">
        ...
        <div className="relative flex justify-between items-center mb-10">
          {/* <div className="absolute top-1/2 left-5 right-5 h-1 bg-gray-700 z-0 rounded-full" /> */}
